...
class SwiftMailer_Mime_Attachment extends SwiftMailer_Mime_SimpleMimeEntity
{
     ...
     */
    public function __construct(SwiftMailer_Mime_HeaderSet $headers, SwiftMailer_Mime_ContentEncoder $encoder, SwiftMailer_KeyCache $cache, SwiftMailer_Mime_Grammar $grammar, $mimeTypes = array())
    {
