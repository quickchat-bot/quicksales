...
abstract class SwiftMailer_Mime_Headers_AbstractHeader implements SwiftMailer_Mime_Header
{
     ...
     * @return string
     */
    protected function createPhrase(SwiftMailer_Mime_Header $header, $string, $charset, SwiftMailer_Mime_HeaderEncoder $encoder = null, $shorten = false)
    {
     ...
     * @return string
     */
    protected function encodeWords(SwiftMailer_Mime_Header $header, $input, $usedLength = -1)
    {
        $value = '';
