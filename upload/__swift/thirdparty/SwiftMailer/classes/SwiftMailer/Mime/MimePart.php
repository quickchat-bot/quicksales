...
class SwiftMailer_Mime_MimePart extends SwiftMailer_Mime_SimpleMimeEntity
{
     ...
     */
    public function __construct(SwiftMailer_Mime_HeaderSet $headers, SwiftMailer_Mime_ContentEncoder $encoder, SwiftMailer_KeyCache $cache, SwiftMailer_Mime_Grammar $grammar, $charset = null)
    {
    ...
    protected function _convertString($string)
    {
        ...
        if (!in_array($charset, array('utf-8', 'iso-8859-1', 'iso-8859-15', ''))) {
            ...
            if (function_exists('mb_convert_encoding')) {
                ...
                throw new SwiftMailer_SwiftMailerException('No suitable convert encoding function (use UTF-8 as your charset or install the mbstring or iconv extension).');
            }
