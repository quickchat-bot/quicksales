...
{
    /**
     * @var SwiftMailer_Signers_HeaderSigner[]
     */
    private $headerSigners = array();

    /**
     * @var SwiftMailer_Signers_BodySigner[]
     */
    ...
    {
        return $this->attach(SwiftMailer_MimePart::newInstance($body, $contentType, $charset)->setEncoder($this->getEncoder()));
    }

    /**
     * Detach a signature handler from a message.
     *
     * @param SwiftMailer_Signer $signer
     *
     * @return $this
     */
    public function attachSigner(SwiftMailer_Signer $signer)
    {
        if ($signer instanceof SwiftMailer_Signers_HeaderSigner) {
            $this->headerSigners[] = $signer;
        } elseif ($signer instanceof SwiftMailer_Signers_BodySigner) {
     ...
     * @return $this
     */
    public function detachSigner(SwiftMailer_Signer $signer)
    {
        if ($signer instanceof SwiftMailer_Signers_HeaderSigner) {
     ...
     *
     * @see SwiftMailer_Mime_SimpleMimeEntity::__clone()
     */
