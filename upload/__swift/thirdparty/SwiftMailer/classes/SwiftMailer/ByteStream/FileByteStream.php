 ...
 * @author Chris Corbyn
 */
class SwiftMailer_ByteStream_FileByteStream extends SwiftMailer_ByteStream_AbstractFilterableInputStream implements SwiftMailer_FileStream
{
    ...
    {
        if (empty($path)) {
            throw new SwiftMailer_IoException('The path cannot be empty');
        }
        $this->_path = $path;
