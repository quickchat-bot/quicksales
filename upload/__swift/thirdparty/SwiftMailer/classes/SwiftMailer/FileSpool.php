...
class SwiftMailer_FileSpool extends SwiftMailer_ConfigurableSpool
{
    ...
    public function __construct($path)
    {
        ...
        if (!file_exists($this->_path)) {
            if (!mkdir($this->_path, 0777, true)) {
                throw new SwiftMailer_IoException(sprintf('Unable to create path "%s".', $this->_path));
            }
        }
    }
    ...
    public function queueMessage(SwiftMailer_Mime_Message $message)
    {
        ...
        throw new SwiftMailer_IoException(sprintf('Unable to create a file for enqueuing Message in "%s".', $this->_path));
    }
