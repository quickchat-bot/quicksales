 ...
 * @author Chris Corbyn
 */
class SwiftMailer_Plugins_AntiFloodPlugin implements SwiftMailer_Events_SendListener, SwiftMailer_Plugins_Sleeper
{
    /**
     ...
     */
    public function __construct($threshold = 99, $sleep = 0, SwiftMailer_Plugins_Sleeper $sleeper = null)
    {
