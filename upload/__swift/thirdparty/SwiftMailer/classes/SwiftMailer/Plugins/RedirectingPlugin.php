 ...
 */
class SwiftMailer_Plugins_RedirectingPlugin implements SwiftMailer_Events_SendListener
{
    /**
     ...
     *
     * @param SwiftMailer_Mime_HeaderSet $headerSet
     * @param string               $type
     */
    private function _filterHeaderSet(SwiftMailer_Mime_HeaderSet $headerSet, $type)
    {
