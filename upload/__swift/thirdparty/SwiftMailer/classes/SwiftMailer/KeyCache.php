...
interface SwiftMailer_KeyCache
{
     ...
     * @param int                    $mode
     */
    public function importFromByteStream($nsKey, $itemKey, SwiftMailer_OutputByteStream $os, $mode);
     ...
     * @param string                $nsKey
     * @param string                $itemKey
     * @param SwiftMailer_InputByteStream $is      optional input stream
     *
     * @return SwiftMailer_InputByteStream
     */
    public function getInputByteStream($nsKey, $itemKey, SwiftMailer_InputByteStream $is = null);
     ...
     * @param string                $nsKey
     * @param string                $itemKey
     * @param SwiftMailer_InputByteStream $is      stream to write the data to
     */
