 ...
 */
class SwiftMailer_Transport_Esmtp_Auth_NTLMAuthenticator implements SwiftMailer_Transport_Esmtp_Authenticator
{
     ...
     * @return bool
     */
    public function authenticate(SwiftMailer_Transport_SmtpAgent $agent, $username, $password)
    {
     ...
     */
    protected function sendMessage1(SwiftMailer_Transport_SmtpAgent $agent)
    {
     ...
     * @return string
     */
    protected function sendMessage3($response, $username, $password, $timestamp, $client, SwiftMailer_Transport_SmtpAgent $agent, $v2 = true)
    {
