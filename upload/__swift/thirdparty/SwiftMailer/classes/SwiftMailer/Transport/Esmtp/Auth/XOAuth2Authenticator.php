 ...
 * Example:
 * <code>
 * $transport = SwiftMailer_SmtpTransport::newInstance('smtp.gmail.com', 587, 'tls')
 *   ->setAuthMode('XOAUTH2')
 ...
 */
class SwiftMailer_Transport_Esmtp_Auth_XOAuth2Authenticator implements SwiftMailer_Transport_Esmtp_Authenticator
{
    /**
     ...
     * @return bool
     */
    public function authenticate(SwiftMailer_Transport_SmtpAgent $agent, $email, $token)
    {
        try {
