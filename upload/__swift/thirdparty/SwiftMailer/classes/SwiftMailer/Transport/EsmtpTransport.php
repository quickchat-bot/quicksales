 ...
 * @author Chris Corbyn
 */
class SwiftMailer_Transport_EsmtpTransport extends SwiftMailer_Transport_AbstractSmtpTransport implements SwiftMailer_Transport_SmtpAgent
{
    // inrease default value to prevent slow-network timeouts
    const DEFAULT_SMTP_TIMEOUT = 180;
    ...
    private $_params = array(
        ...
        'host' => 'localhost',
        'port' => 25,
        'timeout' => self::DEFAULT_SMTP_TIMEOUT,
        'blocking' => 1,
        'tls' => false,
     ...
     */
    public function __construct(SwiftMailer_Transport_IoBuffer $buf, array $extensionHandlers, SwiftMailer_Events_EventDispatcher $dispatcher)
    {
