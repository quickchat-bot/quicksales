...
class SwiftMailer_Transport_MailTransport implements SwiftMailer_Transport
{
     ...
     *
     * @param SwiftMailer_Transport_MailInvoker  $invoker
     * @param SwiftMailer_Events_EventDispatcher $eventDispatcher
     */
    public function __construct(SwiftMailer_Transport_MailInvoker $invoker, SwiftMailer_Events_EventDispatcher $eventDispatcher)
    {
    ...
    public function send(SwiftMailer_Mime_Message $message, &$failedRecipients = null)
    {
        ...
        if (0 === $count) {
            $this->_throwException(new SwiftMailer_TransportException('Cannot send message without a recipient'));
        }
