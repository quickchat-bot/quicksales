...
class SwiftMailer_Preferences
{
    ...
    {
        SwiftMailer_DependencyContainer::getInstance()->register('properties.charset')->asValue($charset);
    ...
    {
        SwiftMailer_DependencyContainer::getInstance()->register('tempdir')->asValue($dir);
    ...
    {
        SwiftMailer_DependencyContainer::getInstance()->register('cache')->asAliasOf(sprintf('cache.%s', $type));
