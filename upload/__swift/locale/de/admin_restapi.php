...
$__LANG = array(
    'apiregenconfirm'       => 'Sind Sie sicher, dass Sie fortfahren möchten?\\nDie Neuerstellung der API-Details wird alle Anwendungen, die die zurzeit eingestellten Zugangsinformation benutzen, zerstören.',
    'restapi'               => 'REST API',
    'manage'                => 'Verwalten',
    'apiinformation'        => 'REST API Information',
    'regenerate'            => 'REST API Zugangsinformation neu erstellen',
    'authenticationdetails' => 'API-Authentifizierungsdetails',
    'apikey'                => 'REST API-Schlüssel',
