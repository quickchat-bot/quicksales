...
$__LANG = array(
    ...
    'desc_staffenabledst'       => 'Если эта опция активирована, QuickSupport будет автоматически определять летнее время и переходить на него.',
    'staff'                     => 'Персонал',
    'desc_staff'                => '',
    ...
    'lostpassworddesc' => 'Пожалуйста введите Ваш зарегистрированный в Системе email адрес и нажмите ОТПРАВИТЬ. Вскоре Вы получите письмо с необходимой информацией для восстановления пароля.',
    'lostpasswordtitle' => 'Забыли пароль',
    'errcaptchainvalidtitle' => 'Неверная капча',
    'errcaptchainvalid' => 'CAPTCHA и фраза не совпадают.',
    'lostpasswordemailsubject' => 'Запрос на потерянный пароль для учетной записи персонала на "%s"',
    'lostpasswordresetdesc' => 'Пожалуйста введите Ваш новый пароль и нажмите ОТПРАВИТЬ.',
    'lpinvalidemail' => 'Не найден аккаунт сотрудника с этим адресом электронной почты.',
    'lprequestsent' => 'Запрос на сброс пароля был отправлен на "%s"',
    'lpsuccess' => 'Пароль успешно изменён; теперь Вы можете войти в Систему с новыми данными.',
    'forgotpasswordemail' => 'Мы получили запрос на сброс Вашего пароля в %1$s Системе Запросов (%2$s). Если Вы считаете, что получили это письмо по ошибке просто проигнорируйте его.

Для сброса/смены пароля щелкните эту ссылку или скопируйте ее в адресную строку Вашего браузера и перейдите по ней:
...
%1$s',
    ...
    'msgstafflicense'           => 'QuickSupport не удалось добавить новую учетную запись для сотрудника, так как достигнут лимит количества учетных записей, указанный в вашей лицензии или подписке. Пожалуйста, <a href="https://accounts.opencart.com.vn">обратитесь в QuickSupport за обновлением или дальнейшей поддержкой</a>.',
    'msgenablestafflicense'     => 'QuickSupport не удалось активировать еще одну учетную запись для сотрудника, так как достигнут лимит количества активных сотрудников, указанный в вашей лицензии или подписке. Пожалуйста, <a href="https://accounts.opencart.com.vn">обратитесь в QuickSupport за обновлением или дальнейшей поддержкой</a>.',
