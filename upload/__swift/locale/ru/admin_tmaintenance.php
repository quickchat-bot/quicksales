...
$__LANG = array(
    ...
    'desc_attachmentsperpass' => 'Укажите количество вложений, которые можно прикрепить к одной странице. QuickSupport поочередно выполнит перебор всех вложений каждой страницы, затем перейдет на загруженные вложения. Чем больше вложений, тем мощнее должен быть сервер. Если система выдает ошибку во время процесса, используйте меньшее количество вложений.',
    'move'                    => 'Переместить',
