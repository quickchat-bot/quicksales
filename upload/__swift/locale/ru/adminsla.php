...
$__LANG = array(
    ...
    'desc_resolutionduehrs'      => 'Ведите количество часов, по истечению которых заявка перейдет в статус решенной. Введите количество часов и минут, разделенных точкой запятой (т.е. 1.30 станет 1 час 30 минут)',
    'resolutionduehrs2'          => 'Время решения (часов)',
    'overduehrs'                 => 'Просроченное время (часов)',
    'desc_overduehrs'            => 'Ведите количество часов, по истечению которых заявка перейдет в статус просроченной. Введите количество часов и минут, разделенных точкой запятой (т.е. 1.30 станет 1 час 30 минут)',
