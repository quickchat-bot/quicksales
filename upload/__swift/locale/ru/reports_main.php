...
$__LANG = array(
    ...
    'notifyreportinsert'       => 'Созданный отчет "%s"',
    'notifyreportupdate'       => 'Сохраненный отчет "%s"',
    ...
    'enablecharts'             => 'Активировать чарты',
    'notifycharttoomuchdata'   => 'Слишком много данных для чарта',
