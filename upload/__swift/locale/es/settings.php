...
$__LANG = array(
    ...
    'cpu_compresswinappdata'               => 'Comprimir datos de QuickSupport Desktop',
    ...
    'd_cpu_enablesmtp'                     => 'Por defecto, QuickSupport utilizará el gestor de correos del servidor para enviar correos electrónicos (PHP mail()) a menos que se configure un servidor SMTP aquí.',
    ...
    'd_security_visitorinactivity'         => 'El tiempo (en segundos) que un visitante tiene que estar inactivo hasta que su sesión se elimine (y ya no sea seguido en el QuickSupport Desktop).',
    'security_cookiedomain'                => 'Dominio de la cookie',
    'd_security_cookiedomain'              => 'Si hay varias instalaciones de QuickSupport compartiendo el mismo nombre de dominio, especifique el dominio de la cookie aquí.',
    'security_cookiepath'                  => 'Ruta de la cookie',
    'd_security_cookiepath'                => 'Si hay varias instalaciones de QuickSupport compartiendo el mismo nombre de dominio, especifique la ruta de la cookie aquí.',
    'cookie'                               => 'Cookie',
    'url'                                  => 'URL',
    ...
    'livesupport_winappsettings'           => 'Configuración de QuickSupport Desktop',
    ...
    'd_ls_activecountrycode'               => 'QuickSupport Desktop puede distinguir entre las llamadas locales e internacionales, basándose en su propio código local del país, por ejemplo: <em>1</em> para los Estados Unidos y <em>34</em> para España.',
    ...
    'd_ls_internationalcallprefix'         => 'Si su proveedor telefónico requiere un prefijo para marcar números internacionales, introdúzcalo aquí y QuickSupport Desktop lo añadirá automáticamente a llamadas internacionales salientes.',
    'ls_recordphonecalls'                  => 'Grabar llamadas telefónicas',
    'd_ls_recordphonecalls'                => 'QuickSupport Desktop subirá las grabaciones de las llamadas al helpdesk, que despés se pueden reproducir en el panel de control del personal.',
    ...
    'd_pr_sizelimit'                       => 'Los correos electrónicos que excedan este tamaño (en kilobytes) no serán descargados al helpdesk.<br /><br/><strong>Nota para los clientes de QuickSupport Download:</strong> Esto debe ser menor a la configuración de <em>php_memory_limit</em> en su <em>php.ini</em>.',
    ...
    'd_t_canirs'                           => 'QuickSupport sugerirá proactivamente artículos pertinentes de la base de conocimientos mientras el usuario redacta su ticket en el centro de soporte.',
    't_maxwcnt'                            => 'Detener búsqueda de IRS después de esta cantidad de palabras',
    'd_t_maxwcnt'                          => 'Cuando un usuario haya introducido esta cantidad de palabras, QuickSupport dejará de buscar en la base de conocimientos respuestas sugeridas.',
    ...
    'd_gateway_enable'                     => 'The QuickSupport SMS Gateway can send alerts directly to mobile phones. For more information, see the <a target="_blank" href="http://support.gfi.com" rel="noopener noreferrer">GFI Support</a>.',
