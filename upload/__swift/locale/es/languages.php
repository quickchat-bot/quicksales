...
$__LANG = array(
    ...
    'desc_flagicon'              => 'Suba o enlace un icono de marcador. Puede utilizar {$themepath} para indicar el directorio de marcadores, por ejemplo: <em>{$themepath}es.gif</em>',
    ...
    'isocode'                    => 'Código ISO',
    'desc_isocode'               => 'Introduzca el código ISO para el idioma. <a href="http://www.iso.org/iso/english_country_names_and_code_elements" target="_blank" rel="noopener noreferrer">Haga clic aquí</a> para una lista de códigos ISO. Por ejemplo: <em>es-es: Español (España)</em>.',
