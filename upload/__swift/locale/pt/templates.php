...
$__LANG = array(
    ...
    'personalizationerrmsg' => 'Você deve fornecer pelo menos um logotipo de cabeçalho',
    ...
    'msgversioncheckfail'           => 'Não foi possível importar este grupo de modelos, pois foi gerado utilizando uma versão antiga de QuickSupport e podem faltar modelos. Caso gostasse de ignorar a verificação da versão, ative <em>Ignorar versão do grupo de modelos</em>.',
    ...
    'desc_templateeditingguideline' => 'Ao utilizar o editor de modelos pode personalizar o aspeto e funcionamento do centro de suporte. Se uma futura atualização de QuickSupport também incluir alterações ao mesmo modelo, ser-lhe-á solicitado o restauro da última versão original do modelo. Tal anulará as alterações ao modelo e necessitará de as voltar a aplicar.<br><br>Para minimizar possíveis dores de cabeça, consulte o <a href="https://go.opencart.com.vn/?pageid=NBTHelpDeskTemplates" target="_blank" rel="noopener noreferrer">guia de melhores práticas de edição de modelos</a> antes de personalizar o seu centro de suporte.',
