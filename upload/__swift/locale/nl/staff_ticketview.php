...
$__LANG = array(
    ...
    'msgmasterviewdel'              => 'QuickSupport kan de volgende hoofdticketweergave(n) niet verwijderen:',
    ...
    'desc_viewticketsperpage' => 'Specify the number of tickets to display before breaking the view into multiple pages. Note: This value cannot exceed the default maximum your administrator has set for staff views.',    'generaloptions'                => 'Algemene opties',
    ...
    'desc_viewafterreplyaction'     => 'Bepaal waar QuickSupport je (of wie deze weergave ook gebruikt) heen moet brengen na het beantwoorden of doorsturen van een ticket.',
