...
$__LANG = array(
    ...
    'newstype'             => 'News Type',
    'desc_newstype'        => '<strong>Public</strong> Will only be published to the customer-facing support centre.<br /><strong>Private</strong> Will only be published to the staff control panel and not to your end users.',
