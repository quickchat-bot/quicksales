...
$__LANG = array(
    ...
    'desc_defaulticon'          => 'Upload or link to an icon for this widget. {$themepath} can be used to point to the helpdesk images directory, for example: <em>{$themepath}icon_widget_default.png</em>. The icon dimensions should be 36x36 pixels. If it doesn\'t meet these requirements, it will automatically be resized.',
    ...
    'displayinnavbar'           => 'Display in support centre navigation bar',
    'desc_displayinnavbar'      => 'This widget will be listed in the main support centre navigation bar, if enabled.',
    'displayinindex'            => 'Display in home page widget list',
    'desc_displayinindex'       => 'This widget will be listed on the home page of the support centre.',
