...
$__LANG = array(
    ...
    'desc_templateeditingguideline' => 'Using the template editor you can customise the look and feel of the support centre. If a future QuickSupport update also includes changes to the same template, you will be asked to restore the template to the latest original version. This will undo your template changes and you will need to reapply them.<br><br>To minimise potential headaches, check out the <a href="https://go.opencart.com.vn/?pageid=NBTHelpdeskTemplates" target="_blank" rel="noopener noreferrer">template editing best practices guide</a> before customizing your support centre.',
