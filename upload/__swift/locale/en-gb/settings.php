...
$__LANG = array(
    ...
    // ======= GENERAL SETTINGS =======
    'd_customurl'                          => 'If you wish to update the domain name, contact NBT support team: <a href="https://support.opencart.com.vn" target="_blank" rel="noopener noreferrer">https://support.opencart.com.vn</a>',
    ...
    'cpu_compresswinappdata'               => 'Compress QuickSupport Desktop data',
    ...
    'd_cpu_enablesmtp'                     => 'By default, QuickSupport will use the server\'s own mail handler to send email (PHP mail()) unless an SMTP server is configured here.',
    ...
    'd_security_visitorinactivity'         => 'The time (in seconds) that a visitor has to be idle for until their session is removed (and are no longer tracked in QuickSupport Desktop).',
    'security_cookiedomain'                => 'Cookie domain',
    'd_security_cookiedomain'              => 'If there are multiple QuickSupport installations sharing the same domain name, specify the cookie domain here.',
    'security_cookiepath'                  => 'Cookie path',
    'd_security_cookiepath'                => 'If there are multiple QuickSupport installations sharing the same domain name, specify the cookie path here.',
    'cookie'                               => 'Cookie',
    'url'                                  => 'URL',
    ...
    'd_loginshare_staffurl'                => 'Enter the URL to the LoginShare API endpoint to use to authenticate staff. <a href="https://go.opencart.com.vn/?pageid=NBTHelpDeskLoginShare" target="_blank" rel="noopener noreferrer">Find out more about LoginShare</a>.',
    ...
    'd_loginshare_userurl'                 => 'Enter the URL to the LoginShare API endpoint to use to authenticate users.  <a href="https://go.opencart.com.vn/?pageid=NBTHelpDeskLoginShare" target="_blank" rel="noopener noreferrer">Find out more about LoginShare</a>.',
    ...
    'd_livesupport_pagerefresh_invalid'    => 'Visitor data refresh interval must be an integer and greater than 60',
    ...
    'livesupport_winappsettings'           => 'QuickSupport Desktop Settings',
    ...
    'd_ls_activecountrycode'               => 'QuickSupport Desktop can distinguish between local and internatinal calls based on your own local country code, for example: <em>1</em> for the US and <em>44</em> for the UK.',
    ...
    'd_ls_internationalcallprefix'         => 'If your phone provider requires a prefix to dial international numbers, enter it here and QuickSupport Desktop will add the prefix to outbound international calls automatically.',
    'ls_recordphonecalls'                  => 'Record phone calls',
    'd_ls_recordphonecalls'                => 'QuickSupport Desktop will upload call recordings to the helpdesk, which can be then played back from the staff control panel.',
    ...
    'd_pr_sizelimit'                       => 'Email larger than this size (in kilobytes) will not be downloaded into the helpdesk.<br /><br/><strong>QuickSupport Download customers note:</strong> This must be less than the <em>php_memory_limit</em> setting in your <em>php.ini</em>.',
    ...
    'd_t_canirs'                           => 'QuickSupport will proactively suggest relevant articles from the knowledgebase as the user types out their ticket in the support centre.',
    't_maxwcnt'                            => 'Stop IRS searching after this many words',
    'd_t_maxwcnt'                          => 'Once the user has typed this many words, QuickSupport will no longer continue searching the knowledgebase for suggested answers.',
    ...
    'ls_adbgcolor'                         => 'Ad Tracking Visitor Background Colour',
    'd_ls_adbgcolor'                       => 'The background colour for a visitor that has been referred to the site by an <b>Ad Campaign</b> (configured within the Staff Control Panel).',
    'ls_adfrcolor'                         => 'Ad Tracking Visitor Foreground Colour',
    'd_ls_adfrcolor'                       => 'The foreground colour for a visitor that has been referred to the site by an <b>Ad Campaign</b> (configured within the Staff Control Panel).',
