...
$__LANG = array (
    ...
    'scsetupconfirmation' => 'QuickSupport is now installed on your web server! Visit the admin control panel to further configure your helpdesk.<br/><br/><span style="color:red"><b>Important note:</b> You will not be able to use QuickSupport until you delete the \'setup\' directory in the root installation directory.</span><br/><br/><span style="color:darkblue"><b>Importing your data:</b></span> You may import help desk data from earlier QuickSupport products, or from other products through the import engine in the admin control panel.',
    ...
    // Knowledgebase
    'sample_kbcategoryname' => 'QuickSupport tips',
    'sample_kbarticlesubject1' => 'Getting to know tickets',
    'sample_kbarticlecontent1' => '<p>All of your customer conversations are tracked as&nbsp;<strong>tickets</strong> in QuickSupport (you might also know them as&nbsp;<em>support tickets</em>,&nbsp;<em>support requests</em> or&nbsp;<em>incidents</em>).</p><p>Any message which comes into the helpdesk - whether from the web, the support center or email - is tracked as a ticket, keeping everything related to a conversation in one place.</p> <h1>Ticket basics</h1> <h2>Departments</h2> <p>Tickets belong to <strong>departments</strong>. A department is like a folder for tickets: tickets can only belong to one department, and you can assign staff teams or individual staff users to departments, which allows them to access and manage tickets in that department.</p> <p>Typical departments might include&nbsp;<strong>Sales</strong>, <strong>Support</strong>, <strong>Opportunities</strong>, <strong>Bugs</strong> and <strong>Receipts</strong>. Departments can be public or private: if a department is public, it means your customers can select that department when creating a new ticket in the support center.</p> <h2>Ticket properties overview</h2> <p>In QuickSupport, a ticket has various ticket properties which let you manage incoming requests effectively and build a speedy workflow.&nbsp;</p> <table> <thead> <tr> <td><strong>Property</strong></td> <td><strong>Examples</strong></td> <td><strong>Description</strong></td> </tr> </thead> <tbody> <tr> <td><strong>Type</strong></td> <td>Issue, Feedback, Bug, Lead</td> <td>A ticket type usually indicates the type of ticket, to label tickets with something specific to their content or context. Which ticket types you create depends on your organization. Some QuickSupport customers like to use ticket types for improved reporting and analytics: for example, the nature of an&nbsp;<strong>Issue</strong> type ticket may well be different to a sales oriented&nbsp;<strong>Lead</strong> ticket.</td> </tr> <tr> <td><strong>Status</strong></td> <td>Open, On Hold, Closed</td> <td>A ticket has a status, which represents where the ticket is on its journey towards resolution. Typically, tickets come in to the helpdesk as <strong>Open</strong>, are set to <strong>On Hold</strong> while you\'re waiting for a response from the customer and are set to&nbsp;<strong>Closed</strong> once the ticket has been resolved. You can create custom statuses to suit your own workflow.&nbsp;&nbsp;</td> </tr> <tr> <td><strong>Owner</strong></td> <td>&nbsp;</td> <td>Tickets can be assigned to individual staff users (who then become owners of the ticket), which usually means that individual will take responsibility for the ticket.</td> </tr> <tr> <td><strong>Priority</strong></td> <td>Low, Medium, High</td> <td>Ticket priorities are fairly self-explanatory. You can create custom priorities to suit your own workflow, and also allow your customers to select their own priority when creating their own tickets (useful because you can configure QuickSupport to trigger different notifications depending on a ticket\'s priority as well as other properties).&nbsp;</td> </tr> </tbody> </table> <h1>How your customers create tickets</h1> <h2>Using the support center</h2> <p>By default, your customers can submit new tickets in the customer-facing support center (<a href="%s">%s</a>).</p> <p><img src="http://media.opencart.com.vn/assets/trial-content/submit-ticket-button.png" alt="" width="297" height="122" /></p> <p>Your customers can select the department to create the ticket in, as well as a priority, subject, message and file attachments.</p> <p>This is highly configurable: you can create custom fields to capture specific pieces of information from your customers (more about that below), determine which departments they can select, whether or not they can select their own priority or whether they can create their own tickets at all.</p> <p><img src="http://media.opencart.com.vn/assets/trial-content/support-center-submit-ticket.png" alt="" width="1000" height="502" /></p> <p><em>Tip: If you have started building your knowledgebase, QuickSupport will automatically search for and suggest answers to your customers as they type out their enquiry (reducing the number of incoming support requests, increasing customer WOW!).</em></p> <h2>Email</h2> <p>You can connect your QuickSupport helpdesk to any number of POP3 or IMAP mailboxes to bring email into the helpdesk from across your organization.</p> <p>By bringing your organization\'s email into the helpdesk, you can enable your team to distribute and collaborate on tickets in one place, rather than managing lots of separate mailboxes and email addresses.&nbsp;</p> <p>QuickSupport will take care of all the message processing automatically: determining what is a reply to an existing conversation and should be added to an existing ticket, which emails should create a new ticket and whether an existing ticket should be reopened. You can also use QuickSupport\'s powerful email parser rules to automate the routing of email and tickets.</p> <p>Find out more about fetching email into QuickSupport below.</p> <h2>The API</h2> <p>You can use the QuickSupport REST API to automatically create tickets on behalf of anyone - whether generated by your backend systems or other integrated apps.&nbsp;<a href="'.SWIFT_Help::RetrieveHelpLink('restapi').'" target="_blank" rel="noopener noreferrer">Find out more about the QuickSupport REST API</a>.</p> <h1>How your team reply to customers and resolve tickets</h1> <p>The magic happens in the staff control panel (<a href="%s/staff">%s/staff</a>).</p> <p>Here, your team can review, assign, reply to and mange tickets. Your team can also create tickets (in effect, sending an email to a customer) or create tickets on a customer\'s behalf (for example, if you want to record the details of a phone conversation or ask someone to follow up with the customer by email at a later date).</p> <p>On the left hand side, you will see the&nbsp;<strong>department tree</strong>. This lists all of departments you have been assigned to. Click on status under each department to view the tickets in that department and set to a particular status.</p> <p><img src="http://media.opencart.com.vn/assets/trial-content/ticket-list-staff.png" alt="" width="1000" height="525" /></p> <p>Above the department tree, there are a couple of shortcut filters: <strong>My Tickets</strong> shows you all of the tickets which are open and are assigned to you.&nbsp;<strong>Inbox</strong> shows tickets which are open.&nbsp;<strong>Unassigned</strong>&nbsp;shows tickets which are open and not yet assigned to anyone.</p> <p>Open a ticket and click on the&nbsp;<strong>Reply</strong> tab to start composing a reply. At the same time, you can change the ticket\'s properties (like the status and priority) which will be saved once you send the reply.</p> <p><img src="http://media.opencart.com.vn/assets/trial-content/reply-to-ticket-staff.png" alt="" width="1128" height="857" /></p> <h1>Fetching email into QuickSupport</h1> <p>You can connect QuickSupport to any number of POP3 and IMAP mailboxes using&nbsp;<strong>Email Queues</strong>, which are responsible for connecting to the mailboxes, fetching email and processing the email into tickets.&nbsp;</p> <p>Find&nbsp;<strong>Email Parser</strong> in the admin control panel (<a href="%s/admin">%s/admin</a>) and then click on&nbsp;<strong>Email Queues</strong>. Click on <strong>New</strong>, and then follow the steps to connect your mailbox.</p> <p>If you are a QuickSupport OnDemand customer (if you are trialing QuickSupport, you are probably trialing QuickSupport OnDemand), you will find an email queue already configured:&nbsp;<em>support@yourname.opencart.com.vn</em>. This email queue is active - you can start sending email to it right away.</p> <p><a href="https://classic.opencart.com.vn/article/673-setting-up-email-queues" target="_blank" rel="noopener noreferrer">Find out more about creating email queues</a>.</p> <h1>Custom fields</h1> <p>QuickSupport\'s powerful custom fields builder lets you customize various forms across the helpdesk - including the new ticket form - allowing you to make sure the right information is collected from customers to equip your team to answer customer enquiries quickly.</p> <p>To create a custom field, find&nbsp;<strong>Custom Fields</strong>&nbsp;in the admin control panel (<a href="%s/admin">%s/admin</a>). First, create a custom field&nbsp;<strong>Group</strong>&nbsp;to organize your custom fields. In this example, we have group called&nbsp;<em>Product information</em>&nbsp;and various fields to collect information about a customer\'s product.</p> <p><img src="http://media.opencart.com.vn/assets/trial-content/custom-field-ticket.png" alt="" width="1098" height="720" /></p> <p><a href="https://classic.opencart.com.vn/article/903-creating-custom-fields-for-capturing-user-and-ticket-information" target="_blank" rel="noopener noreferrer">Find out more about customizing your helpdesk with custom fields</a>.</p> <h1>Turbo charging</h1> <p>QuickSupport is ready to go out of the box. While we\'ve quickly gone through the basics, there is a lot more QuickSupport can do to turbo charge your support and enable your team to improve customer satisfaction.&nbsp;</p> <p>If you\'re ready to dive in, we suggest starting here:</p> <ul> <li><a href="https://classic.opencart.com.vn/article/1100-establishing-service-level-agreements-slas-and-escalations" target="_blank" rel="noopener noreferrer">Configuring SLA plans to set reply and ticket resolution deadlines</a></li> <li><a href="https://classic.opencart.com.vn/article/889-reusing-common-replies-and-updates-using-macros" target="_blank" rel="noopener noreferrer">Ticket macros to speed up ticket responses</a></li> <li><a href="https://classic.opencart.com.vn/article/912-viewing-sorting-and-filtering-your-support-tickets" target="_blank" rel="noopener noreferrer">Customizing ticket views in the staff control panel</a></li> <li><a href="https://classic.opencart.com.vn/article/912-viewing-sorting-and-filtering-your-support-tickets" target="_blank" rel="noopener noreferrer">Creating custom ticket filters (saved searches) in the staff control panel</a></li> </ul>',
    'sample_kbarticlesubject2' => 'Getting started with live support',
    'sample_kbarticlecontent2' => '<p>QuickSupport is the fastest way to start offering an engaging, real-time live support experience to your customers.</p> <p>Communicate with your customers over any channel - the web, email, live chat and phone - switch between them seamlessly, and maintain a single, simple support history in QuickSupport that is only ever one click away from your team.&nbsp;</p> <p>If your organization is serious about scaling live support as a go-to option for your customers, QuickSupport already has you covered with the tools needed with visitor monitoring, intelligent chat routing, proactive chat invitations sent to your customers and more.</p> <h1>QuickSupport Desktop</h1> <p>Your team uses QuickSupport Desktop (for Windows) to connect to your helpdesk to monitor visitors to your website, handle live chats and calls. It is an easy to use, powerful application built for the desktop for speed.</p> <p><a href="http://hotfix.opencart.com.vn/latest.php?product=kd&amp;platform=win32&amp;buildtype=stable">Download QuickSupport Desktop</a>.</p> <p><img src="http://media.opencart.com.vn/assets/trial-content/kayako-desktop.png" alt="" width="1036" height="660" /></p> <h1>Get started with live chat</h1> <p>After downloading and installing, QuickSupport Desktop will walk you through logging in to your helpdesk using your staff user name and password.&nbsp;After logging in to the helpdesk, visit your&nbsp;<strong>support center</strong> in your web browser.</p> <p>You should now see that the&nbsp;<strong>live support&nbsp;</strong>button now says online.</p> <p><img src="http://media.opencart.com.vn/assets/trial-content/live-support-button.png" alt="" width="454" height="121" /></p> <p>Clicking on this button opens a live chat request form. You can try this yourself &nbsp;(but you\'ll be chatting with yourself, if you\'re also the staff user signed into QuickSupport Desktop!).</p> <p>Once a customer is in a live chat, their chat window looks like this:</p> <p><img style="border-width: 0; background: none;" src="http://media.opencart.com.vn/assets/trial-content/customer-chat-window.png" alt="" width="653" height="801" /></p> <p>Whether the live support is online or offline is determined by who in your team has set their status to&nbsp;<strong>available</strong>&nbsp;in QuickSupport Desktop (check the top-left icon). If none of your team is available, when a customer clicks on the <em>offline</em>&nbsp;live support button they will be invited to leave a message.</p> <h1>Chat Gateway</h1> <p>QuickSupport Desktop for Windows is not the only way to handle live chats. Using the QuickSupport Chat Gateway, your team can log in to your helpdesk using any instant messenger client that supports Jabber (such as Adium, Messages for Mac, Pidgin and Trillian) and handle live chats from anywhere and on the go.</p> <p><img style="border-width: 0; background: none;" src="http://media.opencart.com.vn/assets/trial-content/chat-gateway.png" alt="" width="617" height="560" /></p> <p><a href="http://www.opencart.com.vn/products/chat-gateway">Find out more about connecting to the QuickSupport Chat Gateway</a>.</p> <h1>Put a live support button on your website</h1> <p>Navigate to the admin control panel and click on&nbsp;<strong>Tag Generator</strong> on the left-hand menu. Walk through the steps, and QuickSupport will generate a piece of code that you can insert into the HTML of any of your web pages.</p> <p><img src="http://media.opencart.com.vn/assets/trial-content/generate-tag.png" alt="" width="838" height="439" /></p> <p>What happens when your customers click on the live support button is completely configurable. By default, you will be able to monitor visitors on any web page which has the live support button code.</p> <p>You can see how visitors found your website, the search terms they used and what they have browsed so far. This is ideal for delivering proactive customer service: whether that is identifying an opportunity to turn a visitor into a customer, or to offer a helping hand to someone who might be lost.</p> <h1>Getting started with phone and click-to-call</h1> <p>With QuickSupport Desktop, you can connect to your existing VoIP service to handle and capture call records into the helpdesk. By handling calls with QuickSupport Desktop, your team will have instant access to your customer\'s support history and information, equipping them to deliver better customer service.</p> <p>Using the software phone built into QuickSupport Desktop, your team can use their existing VoIP provider, such as Vonage, and sign in to their extension.</p> <p><img src="http://media.opencart.com.vn/assets/trial-content/kayako-desktop-call.png" alt="" width="1032" height="660" /></p> <p>Calls can be answered and made right from QuickSupport Desktop as with any other software phone. Each call is logged in the helpdesk and added to your customer\'s support history, and if call recording is enabled, can be played back from the helpdesk.</p> <h2>Click-to-call</h2> <p>As well as being able to generate live support button for your customers to request live chats, if you decide to handle calls using QuickSupport you can create a&nbsp;<strong>click-to-call</strong> request button.</p> <p><img src="http://media.opencart.com.vn/assets/trial-content/click-to-call-button.png" alt="" width="185" height="118" /></p> <p>A click-to-call button works in a similar way to a live chat button. Your customer will be asked for the name, request subject and phone number. Rather than receiving a new chat request, your team will receive a click to call request which they can instantly respond to with a call.</p> <p><img src="http://media.opencart.com.vn/assets/trial-content/click-to-call-request.png" alt="" width="1032" height="243" /></p> <p>If available, QuickSupport will automatically load the customer\'s support history. Customer WOW, guaranteed.</p> <p><a href="https://classic.opencart.com.vn/article/707-enabling-voip-phone-support-in-kayako-desktop" target="_blank" rel="noopener noreferrer">Find out more about using QuickSupport Desktop with your VoIP service</a>.</p> <h1>Browse live support history</h1> <p>All of your customers\' live support history - both chats, calls and post-chat satisfaction surveys - can be managed in the staff control panel under the&nbsp;<strong>Live Support</strong> tab. From here, you can search and filter live support records, add notes and play back any call recordings.</p> <p><img src="http://media.opencart.com.vn/assets/trial-content/live-support-history.png" alt="" width="1122" height="705" /></p> <p>In addition, any live chat or call captured by the helpdesk will be visible under a customer\'s profile (in the staff control panel under the&nbsp;<strong>Users</strong> tab) and also any ticket your customer may create in the future.&nbsp;</p> <p>Your team is only ever one click away from a complete customer support history.</p> <h1>Keep going</h1> <p>If you\'re ready to dig even further into what you can achieve with live support using QuickSupport:</p> <ul> <li><a href="https://classic.opencart.com.vn/article/1324-installing-and-configuring-kayako-desktop" target="_blank" rel="noopener noreferrer">QuickSupport Desktop user guide</a></li> <li><a href="https://classic.opencart.com.vn/article/914-enabling-live-chat-on-your-support-center-and-websites" target="_blank" rel="noopener noreferrer">Administrator\'s guide to live support</a> (for configuring live support routing, visitor rules, staff skills)</li> <li><a href="https://classic.opencart.com.vn/article/914-enabling-live-chat-on-your-support-center-and-websites" target="_blank" rel="noopener noreferrer">Staff user\'s guide to live support</a> (reviewing live support histories, canned responses)</li> </ul>',

    // News
    'sample_newscatname' => 'General',
    'sample_newsarticletitle1' => 'Welcome to QuickSupport',
    'sample_newsarticlecontent1' => '<p>Welcome to the&nbsp;<strong>staff control panel</strong> - where the magic happens. This is the place where your team delights your customers: where they respond to and resolve tickets, review live chat histories, manage customers, publish self-service content and run reports.</p> <h2>Types of user</h2> <p>In QuickSupport, your customers are called&nbsp;<strong>end-users</strong> and your team users are called&nbsp;<strong>staff users</strong> (you might refer to them as agents or operators).</p> <p>These two types of user are distinct. End-users are managed here in the staff control panel (click on&nbsp;<strong>Users</strong> at the top). Staff users are managed in the&nbsp;<strong>admin control panel</strong> (<a href="%s/admin">%s/admin</a>).</p> <p>A staff user can only access the admin control panel if they are part of a&nbsp;<strong>staff team</strong>&nbsp;which has permission to access to the admin control panel.</p> <h2>What next?</h2> <ul> <li>Read through the quick&nbsp;<a href="https://classic.opencart.com.vn/section/194-quick-start-guides" target="_blank" rel="noopener noreferrer">getting started guide</a>.</li> <li>Bring your team - log in to the <a href="%s/admin/">admin control panel</a> and add staff teams and users.</li> </ul> <h2>Other areas of the helpdesk</h2> <p>QuickSupport has three main areas:</p> <ul> <li><a href="%s/staff">Staff control panel</a>&nbsp;- you are here.</li> <li><a href="%s/admin">Admin control panel</a>&nbsp;- where the configuration happens. Any major configutation of the helpdesk - such as changing settings, configuring email or changing the look and feel of the support center - takes place here.</li> <li><a href="%s/">Support center</a>&nbsp;- the central place for your end-users to get customer support. Here they can find answers to their questions in the knowledgebase, or contact your team by submitting a ticket or starting a live chat.</li> </ul> <h2>This is a news article</h2> <p>This is a <strong>news article</strong>. News articles can be published publicly (available in the support center), privately (only available in the staff control panel and visible to your team, like this one) or globally (both). To manage news articles,&nbsp;click&nbsp;<strong>News</strong> at the top.</p><p>You can delete this demo article at any time.</p>',
    'sample_newsarticletitle2' => 'Welcome to the support center',
    'sample_newsarticlecontent2' => '<p>Welcome to the <strong>support center</strong>, the go-to place for support for your customers.&nbsp;Your customers can browse and search self-service content like the knowledgebase and news.&nbsp;</p> <p>If they can\'t find an answer, they can submit a new ticket or start a live chat (if your staff are available) to get in touch with your team. If your end-user already has an account, they can log in to the support center to browse and manage their previous correspondence with you.</p> <h2>Your customers</h2> <p>In QuickSupport, your customers are called <strong>end-users</strong> (and members of your team are called <strong>staff users</strong>).</p> <p>By default, your end-users can use the entire support center and submit new tickets without registering. If an end-user submits a ticket, the helpdesk will create an account for them. With QuickSupport, all of this is&nbsp;configurable: you can control who can submit tickets, who can register and which groups of users can access certain parts of the support center.</p> <h2>What next</h2> <p>While you\'re here, get a feel for how your customers might use the support center.</p> <ul> <li><a href="%s/Knowledgebase/List">Check out the knowledgebase</a>&nbsp;and browse the example articles</li> <li>Try and <a href="%s/Tickets/Submit">submit a ticket</a></li> <li>Start exploring the&nbsp;<a href="%s/staff">staff control panel</a>, and find that ticket you submitted to yourself</li> </ul> <h2>Other areas of the helpdesk</h2> <p>QuickSupport has three main areas:</p> <ul> <li><a href="%s/">Support center</a> - you\'re here.</li> <li><a href="%s/staff">Staff control panel</a> - where the magic happens. Your team will log in to the staff control panel to answer tickets, manage users and publish self-service content to the support center.</li> <li><a href="%s/admin">Admin control panel</a> - where the configuration happens. Any major configutation of the helpdesk - such as changing settings, configuring email or changing the look and feel of the support center - takes place here.</li> </ul> <h2>This is a news article</h2> <p>This is a&nbsp;<strong>news article</strong>. News articles can be published publicly (available in the support center, like this article), privately (only available in the staff control panel) or globally (both). To manage news articles, log in to the <a href="%s/staff/">staff control panel</a> and click <strong>News</strong>.</p><p>You can delete this demo article at any time.</p>',
    ...
    'sample_cannedmessagecontent' => 'This is a demo canned response. A canned response is a prescribed reply which can be used by your team in live chat conversations, to speed up support (using QuickSupport Desktop, they can even assign canned responses to hotkey combinations).',
