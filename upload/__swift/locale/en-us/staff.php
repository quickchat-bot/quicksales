...
$__LANG = array (
    ...
    'lostpassworddesc' => 'Please enter your email address and click Submit. You will receive an email with a link to reset your staff password shortly.',
    'lostpasswordtitle' => 'Lost Staff Password',
    'errcaptchainvalidtitle' => 'Invalid Captcha',
    'errcaptchainvalid' => 'The CAPTCHA letters entered did not match, please try again.',
    'lostpasswordemailsubject' => 'Lost password request for staff account at %s',
    'lostpasswordresetdesc' => 'Please enter your new password below and click Submit to reset your staff password.',
    'lpinvalidemail' => 'No staff account found with that email address.',
    'lprequestsent' => 'Staff password reset email has been sent to %s',
    'lpsuccess' => 'Your staff password has been changed. You may now login with your new credentials.',
    'forgotpasswordemail' => 'We have received a request to reset your staff account password for the %1$s helpdesk (%2$s). If you believe you have received this message in error, please ignore it.

To reset your staff password, click the link below or copy and paste the link into your browser location bar:
...
// Insert Staff Group
    ...
    'msgstafflicense' => 'Kayako could not add another staff user account because you have reached the maximum number of staff users allowed by your license or subscription. Please <a href="https://accounts.gfi.com"> upgrade your subscription</a>.',
    'msgenablestafflicense' => 'Kayako could not enable any more staff user accounts because you have reached the maximum number of active staff users allowed by your license or subscription. Please <a href="https://accounts.gfi.com"> upgrade your subscription</a>.',
