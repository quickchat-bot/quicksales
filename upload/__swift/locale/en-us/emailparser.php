...
$__LANG = array (
    ...
    'vcaccesstoken' => 'Received access token',
    'vcidtoken' => 'Received ID token with user email address',
    ...
    'desc_authtype' => 'Select the authentication method to connect to the mail server',
    'authtype_basic' => 'Basic',
    'authtype_oauth' => 'OAuth',
    'authclientid' => 'Client Id',
    'desc_authclientid' => 'The client id provided by the email provider when registering the client',
    'authclientsecret' => 'Client Secret',
    'desc_authclientsecret' => 'The client secret provided by the email provider when registering the client',
    ...
    'desc_smtphost' => 'For example: smtp.gmail.com',
