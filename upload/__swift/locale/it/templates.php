...
$__LANG = array(
    ...
    'desc_templateeditingguideline' => 'Utilizzando l\'editor di modelli puoi personalizzare l\'aspetto del centro di supporto. Se un aggiornamento futuro di QuickSupport include modifiche allo stesso modello, verrà chiesto di ripristinare il modello all\'ultima versione originale. Questo annullerà le modifiche apportate al modello e sarà necessario riapplicarle.<br><br>Per ridurre potenziali mal di testa dai un\'occhiata alla <a href="https://go.opencart.com.vn/?pageid=GFIHelpDeskTemplates" target="_blank" rel="noopener noreferrer">guida sulla modifica dei modelli</a> prima di personalizzare il centro di supporto.',
