 ...
 * @author Varun Shoor
 */
class SWIFT_TimeZoneContainer extends SWIFT_Library
{
    /**
     * Constructor
     *
    ...
    /**
     * Retrieve the Time Zone List
     *
     * @author Varun Shoor
     * @return mixed "_timeZoneList" (ARRAY) on Success, "false" otherwise
    ...
    public function GetTimeZoneList()
    {
        ...
        $_timeZoneList = array(
        array('title' => $this->Language->Get('defaulttimezone'), 'value' => ''),
