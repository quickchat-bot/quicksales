 ...
 */
class SWIFT_ImportTable_Tech_news extends SWIFT_ImportTable
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct($_SWIFT_ImportManagerObject, 'Tech_news');

        if (!$this->TableExists('tech_news')) {
            $this->SetByPass(true);
        }
...
//        }
        ...
        $this->DatabaseImport->QueryLimit("SELECT * FROM tech_news ORDER BY id ASC", $this->GetItemsPerPass(), $this->GetOffset());
        while ($this->DatabaseImport->NextRecord()) {
            ...
            $this->GetImportManager()->AddToLog('Importing Private News: ' . htmlspecialchars($this->DatabaseImport->Record['title']), SWIFT_ImportManager::LOG_SUCCESS);
    ...
    protected function GetTotal()
    {
        ...
        $_countContainer = $this->DatabaseImport->QueryFetch("SELECT COUNT(*) AS totalitems FROM tech_news");
