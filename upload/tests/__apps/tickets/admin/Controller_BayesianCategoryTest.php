...
/**
 * Class Controller_BayesianCategoryTest
 * @group tickets
 */
class Controller_BayesianCategoryTest extends \SWIFT_TestCase
{
    public function testConstructorReturnsClassInstance()
    {
        $obj = $this->getController();
        $this->assertInstanceOf('Tickets\Admin\Controller_BayesianCategory', $obj);
    }
    ...
    public function testRunChecksReturnsTrue()
    {
        ...
        $this->assertFalse($method->invoke($obj, 1),
            'Returns false with admin_tcaninsertbayescategory = 0');
    ...
    /**
     * @return Controller_BayesianCategoryMock
     */
    private function getController()
    {
        $view = $this->getMockBuilder('Tickets\Admin\View_BayesianCategory')
            ->disableOriginalConstructor()
            ->getMock();

        return $this->getMockObject('Tickets\Admin\Controller_BayesianCategoryMock', [
            'View' => $view,
        ]);
    }
}

class Controller_BayesianCategoryMock extends Controller_BayesianCategory
{
