...
/**
 * Class Controller_BanTest
 * @group parser
 * @group parser-admin
 */
class Controller_BanTest extends \SWIFT_TestCase
{
    /**
    ...
    {
        $obj = $this->getMocked();
        $this->assertInstanceOf('Parser\Admin\Controller_Ban', $obj);
    }
    ...
    public function testRunChecksReturnsTrue()
    {
        ...
        $method = $this->getMethod(Controller_BanMock::class, 'RunChecks');
    ...
    public function test_RenderConfirmationReturnsTrue()
    {
        ...
        $method = $this->getMethod(Controller_BanMock::class, '_RenderConfirmation');
    ...
    public function testEditSubmitReturnsTrue()
    {
        ...
        \SWIFT::GetInstance()->Database->method('QueryFetch')->willReturn(['parserbanid' => 1]);
        \SWIFT::GetInstance()->Database->Record = ['parserbanid' => 1];
    ...
    /**
     * @return \PHPUnit_Framework_MockObject_MockObject|Controller_BanMock
     */
    private function getMocked()
    {
        $mockView = $this->getMockBuilder(View_Ban::class)
        ...
        return $this->getMockObject('Parser\Admin\Controller_BanMock', ['View' => $mockView]);
    }
}

class Controller_BanMock extends Controller_Ban
{
