...
class FunctionsTest extends SWIFT_TestCase
{
	public function ConvertTextUrlsToLinksProvider()
	{
		return [
			...
			['<img src="https://www.opencart.com.vn/image.jpg" />', ['http'], [], '<img src="https://www.opencart.com.vn/image.jpg" />'],
			['<img src="www.opencart.com.vn/image.jpg" />', ['http'], [], '<img src="www.opencart.com.vn/image.jpg" />'],
